...
## 12. 日付フィールドをdatepickerに変更する

+ `$ yarn add pikaday`を実行<br>

+ `app/javascript/components/EventForm.jsx`を編集<br>

```jsx:EventForm.jsx
import React, { useEffect, useRef, useState } from 'react'; // 編集
import Pikaday from 'pikaday'; // 追加
import { isEmptyObject, validateEvent, formatDate } from '../helpers/helpers'; // 編集
import 'pikaday/css/pikaday.css'; // 追加
...
const EventForm = () => {
  ...
  const dateInput = useRef(null); // 追加
...
+ `node_modules/pikaday/pikaday.js`を編集<br>
...
+ [Pikaday](https://github.com/Pikaday/Pikaday) <br>

+ [React Date Picker](https://www.npmjs.com/package/react-datepicker) <br>

+ [他のライブラリとのインテグレーション – React](https://ja.reactjs.org/docs/integrating-with-other-libraries.html) <br>

+ 参考: [How can I use Pikaday with ReactJS? – Stack Overflow](https://stackoverflow.com/questions/30058477/how-can-i-use-pikaday-with-reactjs) <br>
